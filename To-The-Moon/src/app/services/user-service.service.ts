...
export class UserServiceService implements OnInit {
  ...
  loginUser: User = { username: '', id: 0, game: { game_game_id: 0, phase: 0, start_date: "04/30/2009" }, portfolio: { portfolio_id: 0, cash_value: 0, stock_value: 0, total_value: 0, positions: [{ position_id: 0, quantity: 0, stock_symbol: 'aarp', portfolio_portfolio_id: 0, portfolio_id_fk: 0 }] }, userRole: '' };
  ...
  public registerTeacher(loginTemplate: LoginTemplate): User {
    ...
    var index = this.users.push({ username: loginTemplate.username, id: this.users.length + 1, game: { game_game_id: 0, phase: 0, start_date: "2010/01/01" }, portfolio: { portfolio_id: 0, cash_value: 0, stock_value: 0, total_value: 0, positions: [{ position_id: 0, quantity: 0, stock_symbol: 'aarp', portfolio_portfolio_id: 0, portfolio_id_fk: 0 }] }, userRole: "Teacher" });
